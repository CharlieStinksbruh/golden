        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <span className="inline-flex items-center px-4 py-2 rounded-full bg-orange-100 text-orange-700 text-sm font-medium mb-4">
            ...
            >
              <Link
                to="/signup"
                className="group px-8 py-4 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-lg font-semibold hover:from-orange-600 hover:to-yellow-600 transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
                Start Free Trial
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border hover:border-orange-200"
              >
                <div className="mb-6">
                  {feature.icon}
                </div>
                ...
                <div className="text-sm font-medium text-orange-600 bg-orange-50 px-3 py-1 rounded-full inline-block">
                  {feature.stats}
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-yellow-500 p-8 rounded-xl shadow-lg text-white transform scale-105">
          ...
          <div className="mt-12">
            <Link
              to="/pricing"
              className="inline-flex items-center px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200"
            >
